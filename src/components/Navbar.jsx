            ...
            <div className="flex  space-x-2">
                <div className="underline text-white font-mono">
                    <a href="https://github.com/vivektrip18" className="flex" target="_blank" rel="noopener noreferrer">
                        <svg className="w-5 h-5 mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                ...
                <a href="https://drive.google.com/file/d/1hOAZ9_z7RNHNnnYGTWhq9NtcNK2I5VSm/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="  flex">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="pink" className="size-5">
